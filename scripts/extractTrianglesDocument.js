...
const DOC_PATH = path.join(__dirname, '../public/word/Triangles_Jeu_Duel.docx');
const OUTPUT_DIR = path.join(__dirname, '../extracted');

async function extractTrianglesDocument() {
  console.log('📄 Extraction du document Triangles_Jeu_Duel.docx...\n');
  ...
  const txtFile = path.join(OUTPUT_DIR, 'Triangles_Jeu_Duel.txt');
